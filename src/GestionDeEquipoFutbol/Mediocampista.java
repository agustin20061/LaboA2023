...
public class Mediocampista extends Jugador{
    ...
    public Mediocampista(String nombre, String apellido, Fecha fechaNacimiento, int edad, Provincia provincia, HashSet<Equipo> listaEquipos, int dorsal, Equipo equipoActual, int golesRecibidos, int cantAsistencias) {
